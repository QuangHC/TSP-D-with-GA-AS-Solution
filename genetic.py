...
class Genetic(object):
    ...
    def mate(self, par2):
        child_chromosome = []
        # Duyệt từng gen trong 2 chromosome, tùy thuộc vào xác suất để sinh ra child_chormosome
...
while not found:
    ...
    # Thêm vào thế hệ tiếp theo 10 cá thể tốt nhất
    new_generation.extend(population[:s])
    # Số lượng cá thể được lai ghép để cho vào trong quần thể
    r = int((90 * POPULATION_SIZE) / 100)
    for _ in range(r):
